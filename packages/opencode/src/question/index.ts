  ...
  export const layer = Layer.effect(
    ...
    Effect.gen(function* () {
      ...
      const ask = Effect.fn("Question.ask")(function* (input: {
        ...
        if (AutofixAuto.has(input.sessionID)) {
          const answers = AutofixAuto.answers(input.questions)
          log.info("auto replied", { sessionID: input.sessionID, questions: input.questions.length, answers })
          return answers
        }
