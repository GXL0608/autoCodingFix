...
export namespace Config {
            ...
            .object({
              source: z
                .object({
                  ...
                  dsn_env: z.string().optional(),
                  table: z.string().optional(),
                  sync_batch: z.number().int().positive().optional(),
                })
                .strict(),
              feedback: z
                .object({
                  use_audio_when_text_missing: z.boolean().optional(),
                  max_audio_bytes: z.number().int().positive().optional(),
                })
                .strict()
                .optional(),
              verify: z
                .object({
                  kind: z.literal("electron_webview_smoke"),
                  command: z.string().optional(),
                  startup_timeout_ms: z.number().int().positive().optional(),
                  healthy_window_ms: z.number().int().positive().optional(),
                })
                .strict()
                .optional(),
              package: z
                .object({
                  command: z.string().optional(),
                  artifact_glob: z.array(z.string()).optional(),
                })
                .strict()
                .optional(),
              version: z
                .object({
                  ...
                  source: z.literal("root_package_json"),
  ...
  export type Autofix = z.infer<typeof Autofix>
  ...
  export const Info = z
    .object({
      ...
      enterprise: z
        ...
        .optional(),
      autofix: Autofix.optional().describe("Experimental autofix queue configuration"),
      compaction: z
        .object({
