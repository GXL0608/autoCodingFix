...
export type ProjectSidebarContext = {
  ...
  navigateToAutofix: (directory: string) => void
  openSidebar: () => void
    ...
    >
      ...
      <ContextMenu.Portal>
        <ContextMenu.Content>
          ...
          <ContextMenu.Item onSelect={() => props.navigateToAutofix(props.project.worktree)}>
            <ContextMenu.ItemLabel>AutoCodingFix</ContextMenu.ItemLabel>
          </ContextMenu.Item>
    ...
    <div class="px-2 py-2 border-t border-border-weak-base">
      <Button
        ...
        onClick={() => {
          ...
          props.ctx.navigateToAutofix(props.project.worktree)
        }}
      >
        AutoCodingFix
      </Button>
...
export const SortableProject = (props: {
  ...
  const tile = () => (
    <ProjectTile
      ...
      navigateToAutofix={props.ctx.navigateToAutofix}
