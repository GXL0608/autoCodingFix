...
import type {
  ...
  ExperimentalAutofixRunContinueResponses,
  ExperimentalAutofixRunGetErrors,
  ExperimentalAutofixRunGetResponses,
  ExperimentalAutofixRunListResponses,
  ExperimentalAutofixStartErrors,
  ExperimentalAutofixStartFeedbackErrors,
  ExperimentalAutofixStartFeedbackResponses,
  ExperimentalAutofixStartResponses,
  ExperimentalAutofixStopErrors,
...
export class Run extends HeyApiClient {
   ...
   * List autofix runs
   *
   * List autofix run history for the current project.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
    ...
    return (options?.client ?? this.client).get<ExperimentalAutofixRunListResponses, unknown, ThrowOnError>({
  ...
  /**
   * Get autofix run detail
   *
   * Get a single autofix run detail.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters: {
      runID: string
  ...
  /**
   * Continue autofix run
   *
   * Start a follow-up autofix run from an existing run, optionally with extra guidance.
   */
  public continue<ThrowOnError extends boolean = false>(
    parameters: {
      ...
      directory?: string
      workspace?: string
      autofixContinueInput?: AutofixContinueInput
    },
    options?: Options<never, ThrowOnError>,
  ) {
    const params = buildClientParams(
      ...
      [
        {
          args: [
            ...
            { in: "query", key: "directory" },
            { in: "query", key: "workspace" },
            { key: "autofixContinueInput", map: "body" },
          ],
        },
      ],
    )
...
export class Autofix extends HeyApiClient {
  /**
   * Get autofix state
   *
   * Get autofix support, queue counts, and active run info for the current project.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
    ...
    return (options?.client ?? this.client).get<ExperimentalAutofixGetResponses, unknown, ThrowOnError>({
   ...
   * Start autofix
   *
   * Start the autofix queue for the current project.
   */
  ...
  /**
   * Start autofix for a single feedback item
   *
   * Start AutoCodingFix for one mirrored feedback item in the current project.
   */
  public startFeedback<ThrowOnError extends boolean = false>(
    parameters: {
      feedbackID: string
      directory?: string
      workspace?: string
  ...
  /**
   * Reset autofix state for a single feedback item
   *
   * Clear the mirrored autofix run history and status for one feedback item in the current project.
   */
  public resetFeedback<ThrowOnError extends boolean = false>(
    parameters: {
      feedbackID: string
      directory?: string
      workspace?: string
   ...
   * Stop autofix
   *
   * Request autofix queue stop for the current project.
   */
  ...
  /**
   * Import autofix feedback
   *
   * Import local autofix feedback data into the mirrored queue for the current project.
   */
  public importFeedback<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
      workspace?: string
      autofixImportInput?: AutofixImportInput
    },
    options?: Options<never, ThrowOnError>,
  ) {
    const params = buildClientParams(
      ...
      [
        {
          args: [
            { in: "query", key: "directory" },
            { in: "query", key: "workspace" },
            { key: "autofixImportInput", map: "body" },
          ],
        },
      ],
    )
  ...
  /**
   * Sync autofix feedback
   *
   * Immediately sync autofix feedback from the configured source.
   */
  ...
  /**
   * List autofix feedback
   *
   * List mirrored feedback records for the current project.
   */
  public feedback<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).get<ExperimentalAutofixFeedbackResponses, unknown, ThrowOnError>({
...
export class Experimental extends HeyApiClient {
  ...
  get autofix(): Autofix {
    return (this._autofix ??= new Autofix({ client: this.client }))
  }
